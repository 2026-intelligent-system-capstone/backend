<!-- Context: project-intelligence/business | Priority: high | Version: 1.2 | Updated: 2026-03-25 -->
...
대학생은 로그인 후 자신에게 배정된 시험을 시작한다. 학생의 응시 흐름은 강의실이 아니라 시험 자체를 중심으로 진행되며, AI는 첫 질문 이후 학생 답변을 분석해 근거, 반례, 한계, 적용을 묻는 후속 질문을 이어간다. 평가가 끝나면 학생은 강점/약점과 개선 방향을 확인하고, 교수자는 학생별 리포트와 통합 분포를 통해 수업 보완 포인트를 본다.
...
- 교수자 관점에서 시험은 강의실 운영 자원이지만, 학생 관점에서는 시험 세션과 결과가 독립된 응시 흐름으로 보여야 한다.
